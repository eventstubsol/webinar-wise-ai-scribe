...
import { Link2, CheckCircle, XCircle, AlertTriangle, RefreshCw } from "lucide-react";
...
const ZoomConnectionCard = ({ zoomConnection, isConnected }: ZoomConnectionCardProps) => {
  const { initializeZoomOAuth, disconnectZoom, syncing, syncWebinarData } = useZoomIntegration();
          ...
          <>
            <div className="text-center py-4">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Connect your personal Zoom account to sync webinar data
              </p>
